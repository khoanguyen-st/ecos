...
namespace KAS.ECOS.API.Migrations
{
    ...
    [Migration("20230109033921_addMomoConfig")]
    partial class addMomoConfig
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KAS.Entity.DB.ECOS.Entities.EndUserList", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d7f4dba0-e5d1-4087-bcca-410919f75985",
                            CreatedDate = new DateTime(2023, 1, 9, 3, 39, 21, 31, DateTimeKind.Utc).AddTicks(7350),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEOFxTlx05BiRQ6fe+lUZdvIV+ENfP8HC+lTq70OaSTLJkHgd0za/r9LitrTURd40Nw==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7fced1ab-d035-47fa-aded-5f0368b76b16",
                            CreatedDate = new DateTime(2023, 1, 9, 3, 39, 21, 37, DateTimeKind.Utc).AddTicks(8728),
                            DeletedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAENKF+65FPoYDtYKm9a+BaPMmdvzclLi/p73OVPIk0m3zWxXWQkBBmOXdBRxZ71obDQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
                            Type = "app",
            ...
            modelBuilder.Entity("KAS.Entity.DB.ECOS.Entities.MomoConfigList", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("EndUserListId")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("EndUserListId");

                    b.ToTable("MomoConfigLists");
                });
            ...
            modelBuilder.Entity("KAS.Entity.DB.ECOS.Entities.MomoConfigList", b =>
                {
                    b.HasOne("KAS.Entity.DB.ECOS.Entities.EndUserList", "EndUserList")
                        .WithMany()
                        .HasForeignKey("EndUserListId");

                    b.Navigation("EndUserList");
                });
